...
db_init_content = """from sqlalchemy import create_engine
...
with open("knowledge_capture_mvp/db/connection.py", "w") as f:
...
with open("knowledge_capture_mvp/core/auth.py", "w") as f:
    f.write(auth_content)

print("Database and authentication utilities created!")
