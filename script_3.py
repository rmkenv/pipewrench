...
models_content = """from sqlalchemy import Column, Integer, String, Text, DateTime, Boolean, ForeignKey, JSON
...
with open("knowledge_capture_mvp/models/database.py", "w") as f:
