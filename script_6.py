# Create AI service for question generation and report creation
ai_service_content = """import json
...
with open("knowledge_capture_mvp/services/ai_service.py", "w") as f:
    f.write(ai_service_content)

print("AI service created!")
print("- services/ai_service.py")