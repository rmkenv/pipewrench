# Create RAG service for chatbot functionality
rag_service_content = """import json
import uuid
...
with open("knowledge_capture_mvp/services/rag_service.py", "w") as f:
    f.write(rag_service_content)

print("RAG service created!")
print("- services/rag_service.py")