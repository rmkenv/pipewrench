...
main_app_content = """from fastapi import FastAPI, Depends, HTTPException, status, UploadFile, File, Form, BackgroundTasks
...
with open("knowledge_capture_mvp/main.py", "w") as f:
